...
public class LoadPokemonCSV2 {
    private static int numLinesToSkip = 0;
    private static char delimiter = ',';

    private static int batchSize = 800; // Iris data set: 150 examples total. We are loading all of them into one DataSet (not recommended for large data sets)
    private static int labelIndex = 4; // index of label/class column
    private static int numClasses = 2; // number of class in pokemon dataset (legendary or not legendary)

    public static void main(String[] args) throws Exception {
        // define csv file location
        File inputFile = new ClassPathResource("datavec/Pokemon.txt").getFile();
