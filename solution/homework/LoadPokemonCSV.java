...
public class LoadPokemonCSV {
    private static File inputFile;
    public static void main(String[] args) throws Exception {
        inputFile = new ClassPathResource("datavec/Pokemon.csv").getFile();

        //Define input reader
        RecordReader rr = new CSVRecordReader(1, ',');
        rr.initialize(new FileSplit(inputFile));

        //Build Pokemon Data Schema first by
        Schema inputDataSchema = new Schema.Builder()
                .addColumnInteger("#")
                .addColumnString("Name")
//                .addColumnCategorical("Type 1", Arrays.asList("Normal", "Poison", "Electric", "Ground", "Fairy", "Fire", "Grass", "Water", "Psychic", "Fighting", "Rock", "Ghost", "Ice", "Dragon", "Steel", "Bug", "Dark", "Flying"))
                .addColumnString("Type 1")
                .addColumnString("Type 2")
                .addColumnInteger("Total")
                .addColumnInteger("Hp")
                .addColumnInteger("Attack")
                .addColumnInteger("Defense")
                .addColumnInteger("Sp. Atk")
                .addColumnInteger("Sp. Def")
                .addColumnInteger("Speed")
//                .addColumnCategorical("Generation",Arrays.asList("1","2","3","4","5","6"))
                .addColumnInteger("Generation")
                .addColumnCategorical("Legendary","FALSE","TRUE")
                .build();
...
//        Type 2: Some pokemon are dual type and have 2 (content missing value)
...
//                        new CategoricalColumnCondition("Embarked",ConditionOp.Equal, ""))
                .categoricalToInteger("Type 1")
                .categoricalToOneHot("Legendary")
                .build();

        Schema outputSchema = tp.getFinalSchema();
        System.out.println("\n\n\nSchema after transforming the data:");
...
//        writeAndPrint(processedData);
    ...
    private static void writeAndPrint(List<List<Writable>> processedData) throws Exception {
        ...
        File outputFile = new File("pokemonTransform.csv");
