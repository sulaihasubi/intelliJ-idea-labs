...
public class BasicRNNExample
{
	...
	*/
    ...
    private static final String sampleString = "*Hello.";//"*Der Cottbuser Postkutscher putzt den Cottbuser Postkutschkasten."

    //A list of all possible characters
    private static final List<Character> LEARNSTRING_CHARS_LIST = new ArrayList<>(); //create list character to stop each character
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        MultiLayerConfiguration config = new NeuralNetConfiguration.Builder()
                ...
                .miniBatch(false)
                .list()
                .layer(0, new LSTM.Builder() // we are building LSTM
        ...
        */
        ...
        INDArray currentCharArray = Nd4j.zeros(1, LEARNSTRING_CHARS_LIST.size(), LEARNSTRING.length); //do you agree this is a tensor? It id 3D(tensor) bec (1,1,1)
        ...
        for(int iterEpoch = 0; iterEpoch < 600; ++iterEpoch) //loop 600 times
        {
